...
class SupportScreenCollector extends StatefulWidget {
  final UserModel user;

  const SupportScreenCollector({super.key, required this.user});

  @override
  _SupportScreenCollectorState createState() => _SupportScreenCollectorState();
}

class _SupportScreenCollectorState extends State<SupportScreenCollector> {
